    ...
    Future<bool> dialogTerima(BuildContext context) async {
      return (await showDialog(
            ...
            builder: (context) => AlertDialog(
              ...
              content: Text("Apakah barang sudah dikelola?"),
              actions: [
                TextButton(
                  onPressed: () {
                    penerimaanKedaluwarsa(
                        context, id_pengajuan, id_barang, jumlah_barang);
      ...
      return (await showDialog(
            ...
            builder: (context) => AlertDialog(
              ...
              actions: [
                TextButton(
                  onPressed: () {
                    hapusKedaluwarsa(context, id_pengajuan);
                    Navigator.pop(context);
                    Navigator.pop(context);
                    Navigator.push(
                        context,
